    ...
    public partial class frmAcc : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "INSERT INTO UserSystem(UserName,Password,FullName,Quyen) VALUES (N'" + textBox1.Text.Trim() + "',N'" + textBox2.Text.Trim() + "',N'" + textBox3.Text.Trim() + "',N'" + comboBox1.SelectedItem.ToString()+"')";
